...
class _ConfirmDetailsState extends State<ConfirmDetails> {
   // List to store cleaned names
  List<Map<String, dynamic>> result = [];
  // Remove name pattern from a list of data
  ...
  String removeNameFromText(String text) {
    // Remove [{name:}] from the text name
  ...
  // Build a rich text with a bullet point
 ...
 // Build the UI for the ConfirmDetails widget
  @override
                      ...
                      child: Form(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            suffixIcon: const Icon(LineIcons.map),//icon
                            labelText: 'Address',
